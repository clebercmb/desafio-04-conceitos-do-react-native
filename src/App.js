...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    console.log('>>>>>handleLikeRepository=', id)
    const response = await api.post(`repositories/${id}/like`)
    //let newRepository = repositories.filter(repository => repository.id === id)
    
    let repositoryIndex = repositories.findIndex(repository => repository.id === id)


    //console.log('####==> repository=', newRepository)
    //newRepository.likes = response.data.likes

    let newRepositories = repositories
    let newRepository = newRepositories[repositoryIndex]
